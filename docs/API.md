...
This API documentation is no longer correct as the new development for the Dashboard is
underway this documentation will like continue to become less and less correct
