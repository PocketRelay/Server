...
/// Generates a random name from the collection of nouns and adjectives above
/// along with a random number suffix
pub fn generate_random_name(rng: &mut StdRng) -> String {
    // Will never need to unwrap, only causes unwrap error when empty inputs
