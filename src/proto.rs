...
define_components! {
    ...
    GameManager (0x4) {
        ...
        // Notify
        NotifyMatchmakingFailed (0xA)
        NotifyMatchmakingAsyncStatus (0xC)
        NotifyGameCreated (0xF)
        NotifyGameRemoved (0x10)
        NotifyGameSetup (0x14)
        NotifyPlayerJoining (0x15)
        NotifyJoiningPlayerInitiateConnections (0x16)
        NotifyPlayerJoiningQueue (0x17)
        NotifyPlayerPromotedFromQueue (0x18)
        NotifyPlayerClaimingReservation (0x19)
        NotifyPlayerJoinCompleted (0x1E)
        NotifyPlayerRemoved (0x28)
        NotifyHostMigrationFinished (0x3C)
        ...
        NotifyProcesssQueue (0x77)
        NotifyPrecenseModeChanged (0x78)
        NotifyGamePlayerQueuePositionChange (0x79)
